    ...
    return (
        <div className="h-[88vh] bg-[#F8DDC9]">
            ...
            <div className='sticky z-[9000] w-[80%] grid-cols-1 mx-auto grid lg:grid-cols-2 gap-[3rem] h-[100%] items-center'>
                <div>
                    <h1 className='text-[35px] md:text-[49px] font-bold'>
                    ...
                    <div className='mt-[2rem] flex-col space-y-6 sm:space-y-0 sm:flex sm:flex-row items-center sm:space-x-6'>
                        <button className='px-[2rem] gap-[0.5rem] hover:bg-[#006A9F] transition-all duration-300 py-[1rem] 
                        text-[18px] font-bold uppercase bg-[#EA5C25] text-black flex items-center spcae-x-2'>
                            <p>Download CV</p>
